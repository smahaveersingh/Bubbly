...
export const whiskey = require("../assets/icons/whiskey.png");
export const wine = require("../assets/icons/wine.png");
export const liquor = require("../assets/icons/liquor.png");
export const beer = require("../assets/icons/beer_1.png");
export const sale = require("../assets/icons/sale.png");
export const champagne = require("../assets/icons/champagne.png");
export const vodka = require("../assets/icons/vodka.png");
export const gin = require("../assets/icons/gin.png");
export const non_alcohol = require("../assets/icons/non-alcoholic.png");
